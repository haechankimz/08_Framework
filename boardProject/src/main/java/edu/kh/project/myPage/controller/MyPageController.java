...
public class MyPageController {
	...
	public String updateInfo(
		...
		if(result > 0 ) {
			...
			// loginMember는 세션에 저장된 로그인된 회원정보가
			// 저장된 객체를 참조하고 있다
			// -> loginMember를 수정하면 세션에 저장된 로그인된 회원 정보가 수정된다
			// == 세션 데이터가 수정됨
	...
	public String fileUpload2(
		...
		// 업로드 된 파일 정보를 INSERT 후 결과 행의 개수 반환 받을 예정
	...
	public String fileUpload3(
		...
		// -> 0번 인덱스 파일이 비어있음 (List가 비어있는 건 아님)
